...
class EditRentingComponent extends Component {
  constructor() {
    super();
    this.state = {
      room_number: 0,
                ...
                <div className="col-md-8 m-auto">
                  ...
                  <form
                    ...
                    onSubmit={e => {
                      ...
                      editRoomRenting({ variables: newRenting });
...
export default graphql(ADD_ROOM_RENTING)(EditRentingComponent);
